...
public class HistoryChat {
    ...
    private static ServerData srv = null;
    ...
    public HistoryChat() {
        ...
        ClientPlayConnectionEvents.JOIN.register((handler, sender, client) -> {
            if (client.isLocalServer()) {
                ...
                srv = client.getCurrentServer();
                assert srv != null;

                logFile = new File(CHAT_HISTORY_DIR + srv.ip.replace(":", ".") + "/commander_chat_history.txt");
                logFileColored = new File(CHAT_HISTORY_DIR + srv.ip.replace(":", ".") + "/commander_chat_colored.txt");
            }
    ...
    private boolean onMessage(Component message) {
        Util.ioPool().execute(() -> {
    ...
    private static void processMessage(Component message) {
