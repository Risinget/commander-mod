...
public class KeyHandler {
    ...
    private static final KeyBinding copyPosViewing            = KeyBindingHelper.registerKeyBinding(new KeyBinding("Copiar posición del bloque donde miras", InputUtil.Type.KEYSYM, GLFW.GLFW_KEY_F10, new KeyBinding.Category(Identifier.tryParse("commander"))));
